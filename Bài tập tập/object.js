...
//     }
// ];
// console.log(listStudent[1].skills[1]);
...
//     const keyWord = (first_name + last_name)
//     .toLowerCase()
//     .replace(/[^\w]|[\s]/g, "")
//     .trim();
//     if(email.includes(keyWord)){
//       checkKeyWord.push(element.first_name + " " + element.last_name);
//     }
//   });
// }
// checkEmail(users);
// console.log("Số người có email giống tên là: "+checkKeyWord.length);


// let is_married = [];
// let is_not_married = [];
// function checkMarried(users){
//   users.forEach(element => {
//     let married = element.is_married;
//     if(married){
//       is_married.push(is_married);
//     }else{
//       is_not_married.push(is_not_married);
//     }
//   });
// }
// checkMarried(users);
// console.log("Số người đã kết hôn là: "+is_married.length);
// console.log("Số người chưa kết hôn là: "+is_not_married.length);
...
// }
// checkAge(users);
// console.log("Số người có tuổi trên 50 là: "+oldPerson.length);

// let allJobs = [];
// let jobsOfUsers = [];
// function checkJobs(users){
//   users.forEach(element => {
//     let job = element.job;
//     if(!allJobs.includes(job)){
//       allJobs.push(job);
//     }
//   });
//   allJobs.forEach((job) => {
//     const userWithJob = users.filter((user) => user.job === job);
//     if(userWithJob.length > 0){
//       let u = [];
//       userWithJob.forEach((uwj) => {
//         u.push(uwj.first_name + " " + uwj.last_name);
//       });
//       jobsOfUsers.push({job, users: u});
//     }
//   })
// }
// checkJobs(users);
// jobsOfUsers.forEach(element =>{
//   console.log(`Số người làm công việc ${element.job} là: ${element.users.length}`);
// });
